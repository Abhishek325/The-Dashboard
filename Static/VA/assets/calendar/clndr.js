...
;(function ( $, window, document, undefined ) {
  ...
  var clndrTemplate = "<div class='clndr-controls'>" +
    "<div class='clndr-control-button'><span class='clndr-previous-button'><b>&lt;</b></span></div><div class='month'><%= month %> <%= year %></div><div class='clndr-control-button leftalign'><span class='clndr-next-button'><b>&gt;</b></span></div>" +
    "</div>" +
